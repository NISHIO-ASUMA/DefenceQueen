...
m_pResultScore{},m_nDefenceScore(NULL),m_nFeedScore(NULL),m_nLastScore(NULL), m_nMathScore(NULL)
{
}
//=======================================================
// デストラクタ
...
void CResultScoreManager::Load(void)
{
	...
	// 餌スコアを読み込む
	m_nFeedScore = m_pLoad->LoadInt("data/SCORE/GameScore.bin");

	// 防衛スコアを読み込む
	m_nDefenceScore = m_pLoad->LoadInt("data/SCORE/QueenLastHp.bin");
}
//=======================================================
// 率の値をスコアに変換する関数
//=======================================================
